...
export const users = [
 ...
 //funcion para ordenar los datos de la tabla de usuarios por nombre, telefono, edad, correo electronico, dinero y estado activo o inactivo , recibe como parametros el objeto a ordenar, la llave por la que se va a ordenar y el orden ascendente o descendente y retorna el objeto ordenado
 export const sortData = (objeto, key, order = 'asc') => {
 ...
 //funcion para filtrar los datos de la tabla de usuarios por nombre y correo electronico y por estado activo o inactivo , recibe como parametros el objeto a filtrar, la busqueda y el estado activo o inactivo y retorna el objeto filtrado , si el nombre o correo electronico incluye la busqueda y el estado activo o inactivo es igual al estado del usuario
 export const filterData = (objeto, search, isActive) => {
   return objeto.filter(user => {
